          ...
          <div className="about-body">
            <div className="about-img">
              ...
              <svg xmlns="http://www.w3.org/2000/svg" id="sw-js-blob-svg" viewBox="0 0 100 100" version="1.1">
                ...
                <path fill="url(#sw-gradient)" d="M12.2,-22.3C16.4,-18.6,20.8,-16.6,25.4,-13.1C30.1,-9.7,35,-4.8,32.8,-1.3C30.6,2.3,21.4,4.7,18,10.4C14.7,16.1,17.2,25.2,15.2,27.6C13.2,30.1,6.6,25.9,0.4,25.2C-5.8,24.5,-11.6,27.3,-12.3,24.1C-13.1,20.9,-8.7,11.7,-11.4,6.7C-14.1,1.7,-23.8,0.8,-28.5,-2.8C-33.3,-6.4,-33.2,-12.7,-29,-15.2C-24.9,-17.7,-16.7,-16.3,-11.2,-19.1C-5.7,-22,-2.9,-29.1,0.6,-30.1C4,-31,8,-25.9,12.2,-22.3Z" transform="translate(50 50)" strokeWidth="0" style={{ transition: '0.3s' }} />
              </svg>
            </div>
            <div className="about-cont">
              ...
              <div className="about-exp">
                <div className="about-exp-body">
                  <span>
                    <h2 className="text-clip">4+</h2>
                    <p>Years of experience in Development</p>
                  </span>

                  <span>
                    <h2 className="text-clip">500+</h2>
                    <p>Successfully Project Completed</p>
                  </span>

                  <span>
                    <h2 className="text-clip">105+</h2>
                    <p>Global Customer</p>
                  </span>
                </div>


                <div className="about-exp-soc">
                  <div>
                    <button className="secondary-button">Download Cv </button>
                  </div>

                  <span className="about-exp-soclist">
                    <a href="https://www.facebook.com/classoluwaferanmi" target="_blank" rel="noreferrer" >
        ...
        <div className="home-c-body">
          ...
          <div className="home-c-form">
            <form>
              ...
              <span>
                <label>Email</label>
                <input type="email" name="fEame" value={email} onChange={(e) => setEmail(e.target.value)} />
              </span>
              <span>
                <label>Subject</label>
